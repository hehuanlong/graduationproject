...
void  show_mq2_dht11(void)
{
	...
	OLED_ShowCN(0,0,26);//火
	OLED_ShowCN(16,0,27);//焰

	OLED_ShowStr(32,4,":",2);	
		
	OLED_ShowCN(0,2,14);//气
	OLED_ShowCN(16,2,15);//体
	OLED_ShowStr(32,2,":",2);
	OLED_ShowStr(40+32,2,"V",2);
	
	OLED_ShowCN(0,4,20);//温
	OLED_ShowCN(16,4,22);//度
	OLED_ShowStr(32,4,":",2);	
	OLED_ShowCN(40+32,4,23);//℃	
		
	OLED_ShowCN(0,6,21);//湿
	OLED_ShowCN(16,6,22);//度
	OLED_ShowStr(32,6,":",2);
	OLED_ShowStr(40+20,6,"%",2);//%
		
	//mq2_value=get_adc2value()*3.3/0xfff;//获取烟雾的值
