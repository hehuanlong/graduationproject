...
#include "sys.h"
#define SCLK PAout(4)
#define MOSI PGout(15)
#define MISO PCin(7)
//

extern u8 cardAllInfo_IDA[5];//卡序列号
//定义MFRC522的CS引脚操作，x=1时CS=1，x=0时CS=0
#define MFRC522_CS(x) x ? GPIO_SetBits(GPIOB,GPIO_Pin_7):GPIO_ResetBits(GPIOB,GPIO_Pin_7)
#define MFRC522_Rst(x) x ? GPIO_SetBits(GPIOC,GPIO_Pin_9):GPIO_ResetBits(GPIOC,GPIO_Pin_9)
/////////////////////////////////////////////////////////////////////
//MF522命令字
/////////////////////////////////////////////////////////////////////
